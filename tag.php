...
<main class="l-main">
  <div class="l-low__blog p-blog">
    <div class="l-inner p-blog__inner">
      <h1 class="c-heading p-blog__heading"><?php single_tag_title(); ?></h1>
      <div class="p-blog__articles">
        <?php if (tag_description()) : ?>
          <div class="p-blog__description"><?php echo tag_description(); ?></div>
        <?php endif; ?>
        <?php if (have_posts()) : ?>
          ...
          <?php endwhile; ?>
        <?php else : ?>
          <p class="p-blog__article-text">このタグの記事はありません</p>
        <?php endif; ?>
